...
const seedDatabase = async () => {
  await Promise.all([
    ...
    Exercise.create({
      exerciseName: "PectoralFly",
      displayName: "Pectoral Fly",
      muscleGroup: "Chest",
  ...
  Exercise.create({
    exerciseName: "CrunchesSitUps",
    displayName: "Crunches/Sit Ups",
   muscleGroup: "Abs",
  ...
  Exercise.create({
    exerciseName: "ScissorKicks",
    displayName: "Scissor kicks",
   muscleGroup: "Abs",
  ...
  Exercise.create({
    exerciseName: "BicepCurling",
    displayName: "Bicep curling",
   muscleGroup: "Arms",
